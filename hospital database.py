...
con=sqlcon.connect(host="localhost",user="root",password='tiger123')#connection to mysql 
cur=con.cursor()
...
def register():
    global e1,e2,e3,e4,e5,e6
    root1=Tk()
    label=Label(root1,text="...REGISTER YOURSELF...",font='arial 25 bold',bg='light blue')
    label.pack()
    frame=Frame(root1,height=500,width=700)
    frame.pack()
...
def get_apoint():
    ...
    if len(a)==0:
        ...
        root3=Tk()
        label=Label(root3,text="APPOINTMENT",font='arial 25 bold',bg='yellow')
        label.pack()
        frame=Frame(root3,height=500,width=500)
        frame.pack()
        if i[3]=='M' or i[3]=='m':
                x="Mr."
...
def apoint():
    ...
    label.pack()
    frame=Frame(root2,height=500,width=600)
    frame.pack()
...
def lst_doc():
    ...
    l1=Label(root4,text='NAME OF DOCTORS',bg='light blue') 
    l1.place(x=20,y=10)
    count=20
    for i in l:
       count=count+20
    ...
    l2=Label(root4,text='DEPARTMENT',bg='light blue')
    l2.place(x=140,y=10)
    count1=20
    for i in m:
       count1=count1+20
    ...
    l4=Label(root4,text='ROOM NO.',bg='light blue')
    l4.place(x=260,y=10)
    count2=20
    for i in n:
       count2=count2+20
...
def ser_avail():
    ...
    frame.pack()
    l1=Label(root5,text='SERVICES AVAILABLE',bg='light blue')
    l1.place(x=20,y=10)
    ...
    l2=Label(root5,text='ROOM NO.',bg='light blue')
    l2.place(x=140,y=10)
    g=[1,2,3,4,5,6,7,8,9]
    count2=20
    for i in g:
    ...
    l5=Label(root5,text='To avail any of these please contact on our no.:- 1234567890')
    l5.place(x=20,y=240)
...
def modify():
    ...
    if len(a)==0:
      ...
      frame.pack()
      l1=Label(root6,text='DATA MODIFICATION',font="arial 15 bold",bg='light blue')
      l1.place(x=75,y=10)
...
def mod_sub():
    global x3,ad
    root7=Tk()
    label=Label(root7,text="MODIFICATION",font='arial 25 bold',bg='light blue')
    label.pack()
    frame=Frame(root7,height=400,width=400)
    frame.pack()
...
label=Label(root,text="=== WELCOME TO CU HOSPITAL PVT. LTD. ===",font="arial 40 bold")
b1=Button(text="Registration",font="arial 20 bold",bg='light blue',command=register)
b2=Button(text="Appointments",font="arial 20 bold",bg='light blue',command=apoint)
...
b6=Button(text="Exit",font='arial 18 bold',command=root.destroy,bg='red')
label.pack()
...
b6.pack(side=BOTTOM,padx=0,anchor="se")
frame=Frame(root,height=500,width=50)
frame.pack()
